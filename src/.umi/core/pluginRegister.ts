...
import * as Plugin_2 from 'D:/Work/TBK/vue-react/ant-design-pro-v5.2.0/src/.umi/plugin-access/rootContainer.ts';
...
import * as Plugin_6 from '../plugin-model/runtime';
  ...
  plugin.register({
    apply: Plugin_2,
    path: 'D:/Work/TBK/vue-react/ant-design-pro-v5.2.0/src/.umi/plugin-access/rootContainer.ts',
  });
  plugin.register({
    apply: Plugin_3,
